...
const Hero = () => {
    return (
        <div className="min-h-[89vh] w-full flex flex-col items-center justify-start relative">
            <div className="relative z-50 flex flex-col items-start justify-start w-[75%]">
                <Nav />
                <HeroBox />
            </div>
            <div className="absolute top-0 left-0 w-[100vw] h-[89vh] bg-tint z-20 flex items-center justify-center">
